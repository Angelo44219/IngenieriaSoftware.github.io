<?php
    ...
    $consulta_publicacion = "select p.titulo,p.descripcion,p.ubicacion,a.estado,a.costo,i.imagen from publicacion p inner join alquiler a on p.id=a.id_publicacion inner join imagen i on p.id=i.id_publicacion";
    $filtro="";
    if($_SERVER["REQUEST_METHOD"]=="GET"){
        $buscador=!empty($_GET['buscador']) ? $_GET['buscador'] : null;
        $filtro=" WHERE p.titulo LIKE '%$buscador%' OR p.ubicacion LIKE '%$buscador%';";
                ...
                <div class='card'>
                  ...
                  <img src='$fila[imagen]' class='card-img-top' alt='...'>
                    ...
                    <div class='card-body'>
                        ...
                        <p class='card-text'><small class='text-bold'>Estado: $fila[estado]</small></p>
